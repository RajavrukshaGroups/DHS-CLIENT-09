        ...
        <div>
            <section className="amenities-section" style={{ paddingTop: '10px' }}>
                <Container>
                    ...
                    <p className='exclusive-text1' style={{ fontSize: '18px', fontFamily: 'emoji', fontWeight: 'bold', textAlign: 'center', marginBottom: '1rem' }}>Defence Habitat – Hassan residential layout is thoughtfully equipped with an array of amenities to elevate your living experience .</p>
                    <Row>
