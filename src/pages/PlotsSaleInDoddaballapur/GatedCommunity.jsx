        ...
        <Col md={6}>
          <ul className="icon-list">
            <li>
              ...
              <span style={{ color: "black" }}>24/7 security surveillance with CCTV monitoring.</span>
            </li>
            <li>
              <FaRoad className="icon" />
              <span style={{ color: "black" }}>Wide, well-laid internal roads for smooth movement.</span>
            </li>
            <li>
              <FaWater className="icon" />
              <span style={{ color: "black" }}>Underground drainage and water supply networks.</span>
            </li>
            <li>
              <FaLightbulb className="icon" />
              <span style={{ color: "black" }}>Street lighting throughout the layout.</span>
            </li>
          </ul>
        </Col>
        <Col md={6}>
          <ul className="icon-list">
            <li>
              ...
              <span style={{ color: "black" }}>Landscaped parks and tree plantation zones.</span>
            </li>
            <li>
              <FaHome className="icon" />
              <span style={{ color: "black" }}>Clubhouse and recreational facilities for residents.</span>
            </li>
            <li>
              <FaStreetView className="icon" />
              <span style={{ color: "black" }}>Walking tracks, play areas, and open community spaces.</span>
            </li>
            <li>
              <FaChartLine className="icon" />
              <span style={{ color: "black" }}>Organised layouts for long-term value appreciation.</span>
            </li>
          </ul>
        </Col>
      </Row>
