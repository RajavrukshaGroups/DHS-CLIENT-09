      ...
      <section className="py-14 px-4 bg-white">
        <div className="max-w-6xl mx-auto text-center">
          <h2 className="text-2xl md:text-3xl font-extrabold text-[#24457b] mb-6">
            Invest in Your Future with Defence Housing Society – Premium Residential Plots in North Bangalore
          </h2>
          ...
          <p className="text-gray-600 mt-4 max-w-4xl mx-auto text-sm md:text-base leading-relaxed text-justify md:text-center">
            Bangalore's real estate market continues to attract investors and homebuyers from across India, and North Bangalore has emerged as one of the most promising destinations for long-term growth. With rapid infrastructure development, excellent connectivity, and proximity to Kempegowda International Airport, the region has become a preferred choice for residential investments. If you are searching for Residential plots for sale in Doddaballapur, Gated community plots for sale in North Bangalore, Defence Housing Society offers the ideal opportunity to own premium land in one of Bangalore's fastest-growing corridors.
          </p>
          <p className="text-gray-600 mt-4 max-w-4xl mx-auto text-sm md:text-base leading-relaxed text-justify md:text-center">
            Whether you are planning to build your dream home or secure a high-appreciation investment, North Bangalore offers unmatched potential. The region combines urban convenience with peaceful surroundings, making it suitable for families, professionals, NRIs, and investors alike.
          </p>
        </div>
      </section>
  ...
  <div className="max-w-6xl mx-auto">
    ...
    <div className="text-center mb-12">
      ...
      <h2 className="text-xl md:text-2xl lg:text-4xl font-bold text-gray-800 mb-4">
        Plots Near <span className="text-[#24457b] text-xl md:text-2xl lg:text-4xl ">Doddaballapur</span>
      </h2>
      ...
      <p className="text-gray-600 text-base md:text-lg leading-relaxed max-w-6xl mx-auto">
        The region surrounding Doddaballapur has become one of Bangalore's hottest real estate zones, 
        with significant infrastructure growth, commercial activity, and property appreciation driving 
        investor interest.
      </p>
    </div>
    ...
    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12">
      {[
        { value: '45 mins', label: 'to Airport', icon: '✈️', color: 'blue' },
        { value: '30%+', label: 'Annual Appreciation', icon: '📈', color: 'green' },
        { value: '2000+', label: 'Acres Industrial Zone', icon: '🏭', color: 'purple' },
        { value: '24/7', label: 'Connectivity', icon: '🚗', color: 'orange' },
      ].map((stat, idx) => (
        <div key={idx} className="bg-white rounded-xl p-4 text-center shadow-sm hover:shadow-md transition-all duration-300 hover:-translate-y-0.5 border border-gray-100">
          <div className="text-2xl mb-2">{stat.icon}</div>
          <div className="text-lg md:text-xl font-bold text-[#24457b]">{stat.value}</div>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-white font-bold text-lg">SH-09 | STRR | Upcoming Metro</p>
          </div>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-white font-bold text-lg">45 mins to Major IT Hubs</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-gray-100">
        ...
        <div className="p-6 md:p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">Excellent Connectivity</h3>
          </div>
          <p className="text-gray-600 text-sm mb-3">Well connected through:</p>
          <div className="space-y-2 mb-4">
            {['SH-09 (State Highway)', 'Satellite Township Ring Road (STRR)', 'Upcoming suburban/metro connectivity'].map((item, i) => (
          ...
          <div className="bg-blue-50 rounded-lg p-3">
            <p className="text-blue-700 text-sm">🚗 Seamless connectivity reduces travel time and enhances accessibility to major business centers</p>
          </div>
        </div>
      </div>
      ...
      <div className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-gray-100">
        ...
        <div className="p-6 md:p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">Strong Commercial Growth</h3>
          </div>
          <p className="text-gray-600 text-sm mb-4">
            Several business parks, aerospace hubs, logistics centers, and IT companies are setting up operations, 
            creating increased demand for residential developments.
          </p>
          <div className="flex flex-wrap gap-2">
            {['🏢 Business Parks', '✈️ Aerospace Hubs', '📦 Logistics Centers', '💻 IT Companies'].map((item, i) => (
              <span key={i} className="bg-green-50 text-green-700 text-xs px-3 py-1 rounded-full">{item}</span>
            ))}
          </div>
        </div>
      </div>
      ...
      <div className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-gray-100">
        ...
        <div className="p-6 md:p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">Ideal for Professionals</h3>
          </div>
          <p className="text-gray-600 text-sm mb-3">Highly preferred by:</p>
          <div className="space-y-2 mb-4">
            {['IT professionals & Business owners', 'NRIs & Frequent travelers', 'Aviation sector employees'].map((item, i) => (
              <div key={i} className="flex items-center gap-2">
          ...
          <div className="bg-purple-50 rounded-lg p-3">
            <p className="text-purple-700 text-sm">📍 Convenient access to Major IT and industrial zones adds tremendous value</p>
          </div>
        </div>
      </div>
      ...
      <div className="group bg-white rounded-2xl shadow-md hover:shadow-xl transition-all duration-300 hover:-translate-y-1 overflow-hidden border border-gray-100">
        ...
        <div className="p-6 md:p-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <h3 className="text-xl font-bold text-gray-800">High Appreciation Potential</h3>
          </div>
          <p className="text-gray-600 text-sm mb-4">
            Real estate near major infrastructure projects tends to appreciate faster. As North Bangalore continues to develop, 
            plots near Doddaballapur are expected to witness significant value growth.
          </p>
          <div className="bg-gradient-to-r from-orange-50 to-orange-100 rounded-lg p-3 text-center">
            <p className="text-orange-700 text-sm font-semibold">📈 Expected 25-30% CAGR in next 5 years</p>
          </div>
        </div>
      </div>
    </div>
    ...
    <div className="bg-white rounded-2xl shadow-lg overflow-hidden mb-12 border border-gray-100">
      <div className="bg-gradient-to-r from-gray-50 to-white p-6 border-b border-gray-100">
        <h3 className="text-xl font-bold text-gray-800 text-center">Why Invest in Doddaballapur?</h3>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-4 divide-y md:divide-y-0 md:divide-x divide-gray-100">
        {[
          { icon: '🚄', title: 'Metro Connectivity', desc: 'Upcoming metro line' },
          { icon: '🏗️', title: 'Infrastructure Boost', desc: 'STRR, Airports, Highways' },
          { icon: '🏭', title: 'Industrial Growth', desc: 'KIADB, ITIR, FOXCONN' },
          { icon: '📈', title: 'High ROI', desc: '30%+ annual appreciation' },
        ].map((item, idx) => (
    ...
    <div className="relative bg-gradient-to-r from-[#24457b] to-[#1a3363] rounded-2xl overflow-hidden shadow-xl">
      ...
      <div className="relative p-8 md:p-10 text-center">
        ...
        <p className="text-blue-100 text-base max-w-2xl mx-auto mb-6">
          Premium plotted developments strategically located near IT Zones, making them ideal for investment 
      ...
      <section className="py-10 px-4 bg-[#f8f9fa]">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-gray-600 text-sm md:text-base leading-relaxed text-justify md:text-center mb-4">
            Doddaballapur is one of the most established and desirable residential areas in North Bangalore. Known for its excellent infrastructure, educational institutions, and peaceful environment, the locality has become a top choice for homebuyers.
          </p>
          <p className="text-gray-600 text-sm md:text-base leading-relaxed text-justify md:text-center mb-8">
            The demand for plots for sale in Doddaballapur continues to grow because of several reasons.
          </p>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-blue-500">
              <h3 className="text-lg font-bold text-[#24457b] mb-3">Prime Residential Location</h3>
              <p className="text-gray-600 text-sm mb-2">Doddaballapur offers:</p>
              ...
              <p className="text-gray-600 text-sm">This makes it one of the most convenient residential destinations in the city.</p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-green-500">
              <h3 className="text-lg font-bold text-[#24457b] mb-3">Strong Social Infrastructure</h3>
              <p className="text-gray-600 text-sm mb-2">The locality has well-developed infrastructure including:</p>
              <ul className="text-gray-600 text-sm list-disc pl-5 space-y-1 mb-3">
              ...
              <p className="text-gray-600 text-sm">Families prefer Doddaballapur because it provides a balanced lifestyle with urban conveniences and green surroundings.</p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-red-800">
              <h3 className="text-lg font-bold text-[#24457b] mb-3">Investment Security</h3>
              <p className="text-gray-600 text-sm">
                Plots in established areas like Doddaballapur offer stable appreciation and strong resale value. Investors looking for safe and profitable real estate options often prefer this locality.
              </p>
            </div>

            <div className="bg-white p-6 rounded-xl shadow-sm border-l-4 border-purple-500">
              <h3 className="text-lg font-bold text-[#24457b] mb-3">Ideal for Independent Homes</h3>
              <p className="text-gray-600 text-sm">
                Many buyers choose plots in Doddaballapur to build spacious independent homes with customized designs and private outdoor spaces.
              </p>
            </div>
          </div>
          
          <p className="text-center font-semibold text-[#24457b] mt-8 max-w-3xl mx-auto">
            With growing demand for premium plotted developments, Doddaballapur remains one of the most promising residential investment destinations in Bangalore.
          </p>
        </div>
      </section>
    ...
    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-8 md:p-12">
      ...
      <div className="space-y-6 text-center">
        <p className="text-gray-600 text-lg leading-relaxed max-w-4xl mx-auto">
          ...
          real estate destinations, offering excellent connectivity,
          rapid infrastructure development, and strong long-term
        ...
        <p className="text-gray-600 text-lg leading-relaxed max-w-4xl mx-auto">
          ...
          developments designed for modern living, long-term value,
          and future growth.
        </p>
